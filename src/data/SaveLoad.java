...
public class SaveLoad {
    ...
    public Entity getObject(String itemName){
        Entity obj = null;
        switch (itemName){
            case "Woodcutter Axe": obj = new OBJ_Axe(gp); break;
            ...
            case "Health Potion": obj = new OBJ_Potion_Red(gp); break;
    ...
    public void load(){
        try{
            ...
            gp.player.gems = ds.gems;
            //PLAYER ITEMS
            gp.player.inventory.clear();
            for(int i = 0; i < ds.itemName.size(); i++){
                gp.player.inventory.add(getObject(ds.itemName.get(i)));
