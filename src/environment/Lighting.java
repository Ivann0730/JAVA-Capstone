...
public class Lighting {
    ...
    public void setLightSource(){
        ...
        if(gp.player.currentLight == null){
            ...
            double x = centerX - (gp.player.currentLight.lightRadius/2);
            double y = centerY - (gp.player.currentLight.lightRadius/2);

            //CREATE A LIGHT CIRCLE SHAPE
            Shape circleShape = new Ellipse2D.Double(x,y,gp.player.currentLight.lightRadius,gp.player.currentLight.lightRadius);
    ...
    public void draw(Graphics2D g2){
        ...
        g2.drawString(situation,100,1300);
    }
}
